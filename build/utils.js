...
function collides(
  ...
  /*: boolean*/
  /** PARSEC CHANGE - override so collide never returns true **/
  return false; // if (l1.i === l2.i) return false; // same element
...
function moveElement(
  ...
  if (typeof y === "number") l.y = y; // PARSEC EDIT -> set last moved to unix ts in seconds
